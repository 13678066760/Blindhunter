...
for point in points_to_bold:
    x, y = point
    plt.scatter([y], [x], color='red', s=100, zorder=5)

for point in occluder_coords:
    x, y = point.x, point.y
    plt.scatter([y], [x], color='orange', s=100, zorder=5)
...
plt.fill_between([y, y + 1], x, x + 1, color='orange', alpha=0.5)
plt.fill_between([y + 1, y + 2], x + 1, x + 2, color='orange', alpha=0.5)
plt.fill_between([y + 1, y + 2], x, x + 1, color='orange', alpha=0.5)
plt.fill_between([y, y + 1], x + 1, x + 2, color='orange', alpha=0.5)
